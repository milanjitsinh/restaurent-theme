...
//print("</pre>");
//0	echo do_shortcode( '[contact-form-7 id="47" title="Contact form 1"]' );
?>
            ...
            <form action="" method="post" role="form" class="contactForm">
                ...
                <div class="row">
                    ...
                    <div class="span4 form-group">
                        ...
                        <input type="text" class="form-control" name="contactNo" id="contactNo" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 8 chars of ">
                        <div class="validation"></div>
                    </div>
                    <div class="span4 form-group">
                        <p>Location: <span>*</span></p>
                        <select name="location" class="valid empty">
                    ...
                    <div class="span4 form-group">
                        <p>Venue : <span>*</span></p>
                        <input type="text" class="form-control" name="venue" id="venue" placeholder="Subject" data-rule="minlen:4" data-msg="">
                        <div class="validation"></div>
                    </div> 
                    <div class="span4 form-group">
                        <p>Date : <span>*</span></p>
                        <input type="date" name="doe" value="" min="2019-07-11" class="valid empty">
                        <div class="validation"></div>
                    </div> 
                    <div class="span4 form-group">
                        <p>Event: <span>*</span></p>
                        <input type="text" class="form-control" name="event" id="event" placeholder="Subject" required>
                        <div class="validation"></div>
                    </div>
                    <div class="span4 form-group">
                        <p>No of Pax: <span> * [ Minimum 300 ]</span></p>
                        <input type="text" class="form-control" name="noofpeople" id="noofpeople" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 8 chars of ">
                        <div class="validation"></div>
                    </div>
